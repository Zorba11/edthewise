...
export default function Chat(props: { apiKeyApp: string }) {
  ...
  const handleTranslate = async () => {
    ...
    if (!response.ok) {
      setLoading(false);
      if (response) {
        alert("Something went wrong went fetching from the API. Make sure to use a valid API key.");
      }
      return;
    }
      ...
      >
        ...
        <Flex direction={"column"} w="100%" mb={outputCode ? "20px" : "auto"}>
          <Flex mx="auto" zIndex="2" w="max-content" mb="20px" borderRadius="60px">
            ...
            >
              <Flex borderRadius="full" justify="center" align="center" bg={bgIcon} me="10px" h="39px" w="39px">
        ...
        {/* Main Box */}
        <Flex direction="column" w="100%" mx="auto" display={outputCode ? "flex" : "none"} mb={"auto"}>
