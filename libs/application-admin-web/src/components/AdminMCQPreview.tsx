import { AdminMCQPreviewStore, AdminMCQStore, IAdminMCQStore } from "@edthewise/application-admin-stores-web";
...
export const AdminMCQPreview = (props: IAdminQPreviewProps) => {
  const container = useContainer();
  const routerStore = useRouterStore();

  const qPreviewStore = container.get<AdminMCQPreviewStore>(ADMIN_TOKENS.AdminmcQPreviewStoreToken);
